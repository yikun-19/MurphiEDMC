...
invariant "test_90"
  !(node[1].cache[0].state = cache_invalid & node[2].cache[0].state = cache_shared & node[3].cache[0].state = cache_invalid & node[4].cache[0].state = cache_shared & node[5].cache[0].state = cache_invalid & node[6].cache[0].state = cache_invalid & node[7].cache[0].state = cache_shared & node[8].cache[0].state = cache_shared);

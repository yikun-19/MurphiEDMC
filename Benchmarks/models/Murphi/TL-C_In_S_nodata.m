...
--     Tree[i].cache.state = None ->
--     forall b : branchType do
--         Tree[Tree[i].sons[b]].cache.state = None
--     endforall
-- endforall;
...
--     forall b : branchType do
--         IsUndefined(Tree[i].slave_pending[b]) ->
--         Tree[Tree[i].sons[b]].cache.state != Branch
--     endforall
-- endforall;
...
--     forall b : branchType do
--         IsUndefined(Tree[i].slave_pending[b]) ->
--         Tree[Tree[i].sons[b]].cache.state != Tip
--     endforall
-- endforall;

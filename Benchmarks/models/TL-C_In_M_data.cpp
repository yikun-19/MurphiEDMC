...
// set goalstate value: 
// set states
mu_Ln[1].mu_cache.mu_line[1].mu_state.value(mu_Tip);
mu_Ln[2].mu_cache.mu_line[1].mu_state.value(mu_Branch);
mu_L1[4].mu_cache.mu_line[1].mu_state.value(mu_Branch);
mu_L1[5].mu_cache.mu_line[1].mu_state.value(mu_Branch);
mu_Ln[3].mu_cache.mu_line[1].mu_state.value(mu_Branch);
mu_L1[6].mu_cache.mu_line[1].mu_state.value(mu_Branch);
mu_L1[7].mu_cache.mu_line[1].mu_state.value(mu_Branch);
// set states

    // set carelist about invariant 
    carelist.clear(); 
    carelist.push_back("Ln[1].cache.line[1].state");
    carelist.push_back("Ln[2].cache.line[1].state");
    carelist.push_back("Ln[3].cache.line[1].state");
    // carelist.push_back("L1[4].cache.line[1].state");
    // carelist.push_back("L1[5].cache.line[1].state");
    // carelist.push_back("L1[6].cache.line[1].state");
    // carelist.push_back("L1[7].cache.line[1].state");

    // // set carelist about rulebase 
    carelist_rb.clear();  
    carelist_rb.push_back("L1[4].cache.line[1].state");
    carelist_rb.push_back("L1[5].cache.line[1].state");
    carelist_rb.push_back("L1[6].cache.line[1].state");
    carelist_rb.push_back("L1[7].cache.line[1].state");
    // carelist_rb.push_back("L3.L2[child_1].link1[child_1][4].opcode");
    // carelist_rb.push_back("L3.L2[child_1].link1[child_1][4].para");
    // carelist_rb.push_back("L3.L2[child_1].link1[child_2][4].opcode");
    // carelist_rb.push_back("L3.L2[child_1].link1[child_2][4].para");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_1][4].opcode");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_1][4].para");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_2][4].opcode");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_2][4].para");

    // carelist_rb.push_back("L3.L2[child_1].link1[child_1][1].opcode");
    // carelist_rb.push_back("L3.L2[child_1].link1[child_2][1].opcode");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_1][1].opcode");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_2][1].opcode");

    // carelist_rb.push_back("L3.L2[child_1].link1[child_1][2].opcode");
    // carelist_rb.push_back("L3.L2[child_1].link1[child_2][2].opcode");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_1][2].opcode");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_2][2].opcode");

    // carelist_rb.push_back("L3.L2[child_1].link1[child_1][3].opcode");
    // carelist_rb.push_back("L3.L2[child_1].link1[child_2][3].opcode");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_1][3].opcode");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_2][3].opcode");
    // carelist_rb.push_back("L3.L2[child_2].link1[child_2][3].opcode");
    // carelist_rb.push_back("L3.link2[child_1][1].opcode");
    // carelist_rb.push_back("L3.link2[child_2][1].opcode");
    // carelist_rb.push_back("L3.link2[child_1][4].opcode");
    // carelist_rb.push_back("L3.link2[child_2][4].opcode");
    carelist_3.clear();
    carelist_flow.clear(); 

...
// set goalstate value: 
// set states
mu_Ln[1].mu_cache.mu_line[1].mu_state.value(mu_None);
mu_Ln[2].mu_cache.mu_line[1].mu_state.value(mu_None);
mu_L1[4].mu_cache.mu_line[1].mu_state.value(mu_None);
mu_L1[5].mu_cache.mu_line[1].mu_state.value(mu_None);
mu_Ln[3].mu_cache.mu_line[1].mu_state.value(mu_None);
mu_L1[6].mu_cache.mu_line[1].mu_state.value(mu_None);
mu_L1[7].mu_cache.mu_line[1].mu_state.value(mu_None);
// set states

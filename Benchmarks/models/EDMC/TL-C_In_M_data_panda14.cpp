...
#include <map>
#include <functional>
std::map<std::string, mu_1_cache_state> goalstateMap;
std::map<std::string, std::function<mu_1_cache_state()>> funcMap;

bool checkFuncAttr(string attr_name)
{
  if (goalstateMap.find(attr_name) != goalstateMap.end())
  {
    mu_1_cache_state curstate_val = funcMap[attr_name]();
...
void Goal_value() {  // makun: set goalstate
  ...
  funcMap["getCacheState(1, a)"] = []() -> mu_1_cache_state { return mu_getCacheState(1, 1); };
  funcMap["getCacheState(2, a)"] = []() -> mu_1_cache_state { return mu_getCacheState(2, 1); };
  funcMap["getCacheState(3, a)"] = []() -> mu_1_cache_state { return mu_getCacheState(3, 1); };
  funcMap["getCacheState(4, a)"] = []() -> mu_1_cache_state { return mu_getCacheState(4, 1); };
  funcMap["getCacheState(5, a)"] = []() -> mu_1_cache_state { return mu_getCacheState(5, 1); };
  funcMap["getCacheState(6, a)"] = []() -> mu_1_cache_state { return mu_getCacheState(6, 1); };
  funcMap["getCacheState(7, a)"] = []() -> mu_1_cache_state { return mu_getCacheState(7, 1); };

  // get smt solution from invariant to set goalstate
// set states
goalstateMap["getCacheState(1, a)"] = mu_Tip;
goalstateMap["getCacheState(2, a)"] = mu_Branch;
goalstateMap["getCacheState(4, a)"] = mu_Branch;
goalstateMap["getCacheState(5, a)"] = mu_Branch;
goalstateMap["getCacheState(3, a)"] = mu_Branch;
goalstateMap["getCacheState(6, a)"] = mu_Branch;
goalstateMap["getCacheState(7, a)"] = mu_Branch;
// set states

    // set carelist about invariant 
    carelist_l1.clear(); 
    carelist_l1.push_back("getCacheState(1, a)");

    carelist_l2.clear(); 
    carelist_l2.push_back("getCacheState(2, a)");
    carelist_l2.push_back("getCacheState(3, a)");

    carelist_l3.clear(); 
    carelist_l3.push_back("getCacheState(4, a)");
    carelist_l3.push_back("getCacheState(5, a)");
    carelist_l3.push_back("getCacheState(6, a)");
    carelist_l3.push_back("getCacheState(7, a)");

...
class designator : public expr {
    ...
    // class identifiers
    enum designator_class {
        Base, ArrayRef, FieldRef
    };
...
public:
    ...
    designator(ste *origin, typedecl *type, bool islvalue, bool isconst, bool maybeundefined,
               double val);    // AP: this constructor is called by getdesignator() (constdecl)
